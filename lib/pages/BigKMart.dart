...
class BigKMart extends StatefulWidget {
  @override
  _BigKMartState createState() => _BigKMartState();
}

class _BigKMartState extends State<BigKMart> {
  @override
          ...
          child: Column(
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text('Fruits and Vegetables',style:TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
            ),
            Padding(
